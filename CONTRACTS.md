...
Cash US$50 = hosting14 + API30 + contingency6. The WP6 amendment reallocates $5 from contingency; API30 splits development/CI/measurement21 and demo9. The owner has confirmed $25 prepaid with replenishment disabled; the additional $5 is pending, and no further paid batch may run until that funding is confirmed. Spend is tracked across CI, local runs and demo against the same budget. Public demo starts after funded evaluation/release; before that the hosted page is available but generation is gated for scheduled smoke tests charged to development. This preserves the $9 demo allocation for 30 public days.
...
| Remaining paid work at the WP6 amendment | Actor calls | Judge calls | Forecast |
|---|---:|---:|---:|
