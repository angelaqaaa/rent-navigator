...
US$50: hosting **14**, API development/CI/measurement **21**, public demo **9**, contingency **6**. The WP6 context amendment reallocates $5 from contingency; the owner has confirmed the additional $5, bringing confirmed API prepayment to $30 with automatic replenishment disabled. This is funding confirmation, not a queried account balance or authorization for further calls. Demo admission budget **$0.30/day for 30 days**; restart-independent bound is prepaid credit, not the in-memory counter. After the failed first WP9 judge smoke, annex §10 reconciles **$20.232** future reservations plus **$0.059251** incurred cost and **$0** unknown hold, leaving **$0.708749** within development $21 with 14 development slots and four live batches; a second smoke and its conditional post-smoke allocation require separate authorization.
