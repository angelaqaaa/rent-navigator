...
The owner has confirmed the additional US$5, bringing confirmed prepayment to **US$30**, with automatic replenishment disabled. Further paid work requires a new explicit authorization. The historical US$50 allocation was hosting14, development/CI/measurement21, demo9 and contingency6; the prospective capacity plan below does not amend the funding record. At the WP6 checkpoint, future reservations totalled **US$20.313**, including **15 development slots**; cumulative incurred cost was **US$0.045685**, leaving **US$0.641315** within development. Subsequent authorized evaluation receipts retain their separate charges and reservations. These are budget calculations, not a queried provider balance; the full US$9 demo allocation remains protected. The documentation update does not change the measured source, and no live run was repeated for it.
...
The current capacity policy is prospective: confirmed historical provider prepayment remains **US$30**; the recommended additional **US$15 is not confirmed**. The target allocation is provider 45, development/CI/measurement 36 and protected demo 9. All future selected work reserves **US$32.430**: 22 fixed diagnostics 1.108, release/warm-ups 17.326, three full gates 13.023 and seven generic allowances 0.973. Including settled incurred 0.232356 gives **US$32.662356** development exposure; with demo 9 the required **US$41.662356** exceeds confirmed 30 by **US$11.662356**. The prospective 45 funding would leave 3.337644 development margin. These are forecasts, not spending or a queried balance; funding confirmation and separate grants remain required.

`LivePermit` requires strict integer schema version 2; old schema 1 permits are rejected without changing other artifact versions. No actual v2 permit may be issued before funding confirmation, the advisor's obligation update and completion/settlement of all 22 diagnostics. The next pending-baseline bootstrap uses the existing `wp9_bootstrap_savings_repair` slot, reserves **US$4.341** for at most 77 actor / 39 judge calls, and preserves two future gates/seven generic allowances totaling **US$26.981**. Regression retains the original active baseline and actual remaining obligations. Source/run/purpose/expiry/prior-ledger binding, known-cost reconciliation and unknown-usage holds remain mandatory. Passing synthetic permit tests does not confirm funds or grant paid authority.

The actual 19-event ledger still has 13 development slots, three future gates, incurred 0.232356, hold 0 and active reservation 0. The proposed replacement of 13 generic allowances with 22 fixed diagnostics and seven generic allowances has not been posted. Historical failures and consumed grants remain unchanged. The 189-input foundation sizing study retains its original source identity; reusing its input counts after integration requires an unchanged complete-request-byte comparison. Sizing does not establish answer quality or 1200/800 output sufficiency, and this update performs no new count or generation.
