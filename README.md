...
The owner has confirmed another **US$20** provider prepayment, raising cumulative confirmed prepayment from **US$30 to US$50**. This is funding confirmation, not a queried provider balance. The development/CI/measurement allocation remains36 and the protected demo allocation9; the remaining5 is unallocated provider reserve. All future selected work still reserves **US$32.430**:22 fixed diagnostics1.108, release/warm-ups17.326, three full gates13.023 and seven generic allowances0.973. Including settled incurred0.232356 gives **US$32.662356** development exposure; with demo9, required funds are **US$41.662356**. The **US$8.337644** forecast surplus comprises3.337644 development margin and5 unallocated reserve. These are forecasts, not spending or an account balance; call limits remain unchanged and separate grants are still required.
...
The actual21-event ledger preserves the original19 events, then records funding confirmation and replacement of13 generic allowances with22 fixed diagnostics and seven generic allowances; three future gates remain. Incurred0.232356, hold0 and active reservation0 are unchanged. No old failed slot or consumed grant is restored. The189-input foundation sizing study retains its original source identity; reusing its input counts after integration requires an unchanged complete-request-byte comparison. Sizing does not establish answer quality or1200/800 output sufficiency, and this update performs no new count or generation.
